...
namespace WebApiAutores.Utilidades
{
    public class HATEOASAutorFilterAttribute : HATEOASFiltroAttribute
    {
            ...
            ResultExecutionDelegate next)
        {
            ...
            //var modelo = resultado.Value as AutorDTO ?? throw new ArgumentNullException("Se esperada una instancia de AutorDTO");
            var autorDTO = resultado.Value as AutorDTO;
            if (autorDTO == null)
            {
                var autoresDTO = resultado.Value as List<AutorDTO> ?? throw new ArgumentException("Se esperada una instancia de AutorDTO o List<AutorDTO>");
